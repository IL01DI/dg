...
- SOV / VSO / OSV / VOS
	- **Rule 1**: There is an adjective, and both the subject and the object are of the same gender and number.
- SOV / VSO
...
With this in mind, there are recommendations that will help you write correctly:
...
- SVO / OVS
	- **Order 5**: When both the subject and the object are of the same gender and number, so it can apply an adjective nearby to specifically affect; or when either the subject or the object contains a prepositional phrase or has a relative clause.
...
Formed by adding a question mark at the end of the sentence. Optionally, can be added the question mark  _num_ at the beginning.
